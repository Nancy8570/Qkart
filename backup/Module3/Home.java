...
public class Home {
    ...
    public Boolean addProductToCart(String productName) {
        try {
             ...
             * 
            */
            List<WebElement> elements=driver.findElements(By.xpath("//*[@id='root']/div/div/div[3]/div[1]/div[2]/div"));
            for(WebElement el:elements){
                if(productName.contains(el.findElement(By.xpath("//*[@id='root']/div/div/div[3]/div[1]/div[2]/div/div/div/p[1]")).getText())){
                    // el.findElement(By.tagName("button")).click();
                    el.findElement(By.xpath("//*[@id='root']/div/div/div[3]/div[1]/div[2]/div/div/div[2]/button")).click();
