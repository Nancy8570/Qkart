...
public class Home {
    ...
    public Boolean verifyCartContents(List<String> expectedCartContents) {
        try {
            ...
            return true;
            // WebElement cartParent = driver.findElement(By.xpath("//*[@id='root']/div/div/div[3]/div[2]"));
            // List<WebElement> cartContents = cartParent.findElements(By.xpath("//*[@id='root']/div/div/div[3]/div[2]/div/div[1]/div"));

            // ArrayList<String> actualCartContents = new ArrayList<String>() {
            // };
            // for (WebElement cartItem : cartContents) {
            //     actualCartContents.add(cartItem.findElement(By.xpath("//*[@id='root']/div/div/div[3]/div[2]/div/div/div/div[2]")).getText().split("\n")[0]);
            // }
